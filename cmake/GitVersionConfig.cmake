...
function(configure_version)
  if(NOT GITVERSION_EXECUTABLE)
    message(STATUS "GitVersion not found. Using default version 0.1.0")
    set(PROJECT_VERSION_MAJOR 0 PARENT_SCOPE)
    set(PROJECT_VERSION_MINOR 1 PARENT_SCOPE)
    set(PROJECT_VERSION_PATCH 0 PARENT_SCOPE)
    set(PROJECT_VERSION "0.1.0" PARENT_SCOPE)
    set(PROJECT_VERSION_PRERELEASE "" PARENT_SCOPE)
    set(PROJECT_VERSION_BUILD "" PARENT_SCOPE)
    set(PROJECT_VERSION_BRANCH "unknown" PARENT_SCOPE)
    set(PROJECT_VERSION_COMMIT "unknown" PARENT_SCOPE)
    set(PROJECT_VERSION_FULL "0.1.0" PARENT_SCOPE)
  else()
    ...
    if(GITVERSION_ERROR)
      message(WARNING "GitVersion error: ${GITVERSION_ERROR}")
      set(PROJECT_VERSION_MAJOR 0 PARENT_SCOPE)
      set(PROJECT_VERSION_MINOR 1 PARENT_SCOPE)
      set(PROJECT_VERSION_PATCH 0 PARENT_SCOPE)
      set(PROJECT_VERSION "0.1.0" PARENT_SCOPE)
